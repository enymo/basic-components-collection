    ...
    return (
        <Clickable
            ...
            className={clsx("relative cursor-pointer disabled:cursor-not-allowed body-m-md h-(--button-height) rounded-(--button-radius) px-(--button-padding-horizontal)", {
                ...
                "border-(length:--button-border-width) text-neutral-000 fill-neutral-000 bg-primary-500 border-primary-400 hover:bg-primary-600 hover:border-primary-500 disabled:bg-neutral-300 disabled:border-neutral-300": variant === "primary",
                "border-(length:--button-border-width) text-secondary-000 fill-secondary-000 bg-secondary-700 border-secondary-600 hover:bg-secondary-800 hover:border-secondary-700 disabled:bg-secondary-300 disabled:border-secondary-300": variant === "secondary",
                ...
                "border-(length:--button-border-width) text-neutral-000 fill-neutral-000 bg-danger-500 border-danger-400 hover:bg-danger-600 hover:border-danger-500 disabled:bg-neutral-300 disabled:border-neutral-300": variant === "danger"
            }, className)}
        >
